...
sudo iptables -t mangle -A OUTPUT -p tcp -m multiport --dports 80,443,2053,2083,2087,2096,8443 -j NFQUEUE --queue-num 200
sudo iptables -t mangle -A OUTPUT -p udp -j NFQUEUE --queue-num 200
